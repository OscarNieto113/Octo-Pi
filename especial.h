...
/*************************************************************
* Implementation of Especial class
*************************************************************/

Especial::Especial() // Constructor por default
	: Item(), especial("") {
}

Especial::Especial(string nombreItem_, string descripcionItem_, unsigned int itemId_, unsigned int precioItem_, string especial_)// Constructor alterno
	: Item(nombreItem_, descripcionItem_, itemId_, precioItem_) {
	especial = especial_;
}

Especial::Especial(const Especial &item)// Constructor por copia
